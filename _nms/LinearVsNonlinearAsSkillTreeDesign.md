...
Description: 
You are designing a skill tree for a game. There are two ways you could do this tree.
The linear approach would be to grant a set amount of points per upgrade (eg, +5 damage per upgrade).
The non-linear approach might be more useful to balance it as it would let you give small bonuses at first and then skyrocket into certain branches after investing a number of points into them.
